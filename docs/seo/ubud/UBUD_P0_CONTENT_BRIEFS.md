# Ubud P0 content brief

## `/ubud` — P0_UPDATE

- Primary intent: decide whether Ubud is the right Bali base.
- Excluded intents: hotel ranking, detailed neighbourhood choice, attraction ranking, itinerary sequencing, transport promises and venue rankings.
- User outcome: understand Ubud's verified planning identity and move to the correct existing specialist owner.
- H1: `Is Ubud the right Bali base for you?`
- Metadata: base-fit framing; exact canonical `https://www.otherbali.com/ubud`.
