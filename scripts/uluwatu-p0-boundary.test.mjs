...
const guideGate = await readFile(new URL("../components/UluwatuVenueGuideGate.tsx", import.meta.url), "utf8");
...
test("Uluwatu pages stay available when a preview database roster is incomplete", () => {
  ...
  assert.doesNotMatch(guideGate, /notFound|getPublishedVenues|publishedUluwatuVenues/);
});
