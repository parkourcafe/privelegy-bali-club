...
const VIDEOS = {
  ...
  // /villas partnership film (2026-07-17): a story-led mixed-media collage
  // explainer — eight gemini_omni beats locked to one style key, Maya voiceover
  // + burned subtitles assembled via Higgsfield explainer. Two language cuts
  // (shared visuals): English + Bahasa Indonesia, toggled on the page. Same
  // click-to-play gate as venues-story (preload="metadata"). Absent on networks
  // that can't reach the CDN → poster fallback.
  "villas-film": ["hf_20260717_191426_32fad8cf-4c0b-4be1-bf2d-bd02446dc969.mp4", 30_000_000],
  "villas-film-id": ["hf_20260717_191619_20088e74-39ed-42f1-b0b6-f288b6a6cf9f.mp4", 30_000_000],
};
