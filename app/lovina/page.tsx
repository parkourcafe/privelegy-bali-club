...
const d = getLightDistrict("lovina")!;

export const metadata: Metadata = {
  title: d.title,
  description: d.metaDescription,
  alternates: { canonical: "/lovina" },
  openGraph: { title: `${d.title} · Other Bali`, description: d.metaDescription, url: `${BASE}/lovina`, type: "article" },
  twitter: { card: "summary_large_image", title: `${d.title} · Other Bali`, description: d.metaDescription },
};

export default function Page() {
  return <LightDistrictLanding slug="lovina" />;
}
