...
const d = getLightDistrict("amed")!;

export const metadata: Metadata = {
  title: d.title,
  description: d.metaDescription,
  alternates: { canonical: "/amed" },
  openGraph: { title: `${d.title} · Other Bali`, description: d.metaDescription, url: `${BASE}/amed`, type: "article" },
  twitter: { card: "summary_large_image", title: `${d.title} · Other Bali`, description: d.metaDescription },
};

export default function Page() {
  return <LightDistrictLanding slug="amed" />;
}
