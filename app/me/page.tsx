...
export default async function MyPerksPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-md px-4 py-10">
      ...
      <h1 className="mt-3 text-2xl font-bold">My offers</h1>
      <p className="text-xs text-stone-500">Venue offers you have redeemed on this device.</p>

      {perks.length === 0 ? (
        <div className="mt-8 rounded-2xl border border-dashed border-stone-300 p-8 text-center text-sm text-stone-500">
          Nothing yet. Redeem a confirmed offer at a venue and it will show up here.
          <div className="mt-4">
