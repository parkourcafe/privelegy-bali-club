// GLSL for the "Smoke Ring" background. Kept verbatim from the Shader Builder
// output — do not reformat or "tidy" it; the uniform packing in ./smoke-ring.ts
// and the macro aliases below are a matched pair.
//
...
/** Fullscreen triangle. Three vertices, no index buffer, no matrices. */
...
/**
 * Covers the viewport with one triangle instead of two — no diagonal seam and
 * no fragments shaded twice along it.
 */
export const FULLSCREEN_TRIANGLE = new Float32Array([-1, -1, 3, -1, -1, 3]);

export const FRAGMENT_SHADER = `// "Smoke Ring" — made with the 21st.dev Shader Builder
// Adapted from Paper Shaders: https://shaders.paper.design/smoke-ring
// Licensed under Apache-2.0: https://github.com/paper-design/shaders
