// Locale registry (Multi-locale public UI rule v2, AGENTS.md, 2026-07-20
...
// id and ru are explicit founder overrides — id for Jakarta-origin domestic
// tourism growth and SEO, ru for the founder's personal network and the
// Canggu resident population — neither tracks international arrival volume.
// Español/Türkçe were considered and declined — see the amendment note for
// why. Indonesian is also the language of the existing partner/owner-outreach
// scripts (EN+ID) — that usage is unchanged and separate from this switcher.
export const PUBLIC_LOCALES = ["en", "id", "zh", "ko", "fr", "ru"] as const;
...
export const LOCALE_META: Record<PublicLocale, LocaleMeta> = {
