...
export const ULUWATU_VENUES: UluwatuVenueContent[] = [
  ...
  },
  {
    ...
    whatToExpect:
      "Open-air tables in a tropical garden, a Japanese-Peruvian-Hawaiian menu (sashimi, rolls, grilled mahi mahi) and a walk-in-friendly rhythm. Kids fit here without anyone flinching.",
    ...
    reservation: "Walk-ins work most nights; contact the venue directly for groups.",
  ...
  },
  {
    ...
    reservation: "Contact the venue directly for dinner reservations; breakfast is walk-in.",
  ...
  },
  {
    ...
    whatToExpect:
      "Counter pastries and stuffed bagels in the morning, casual dinner plates and drinks after dark, with regular live-music evenings. Part of a small Bukit family of Artisan branches — this record is the Uluwatu/Suluban room. Contact the venue for dinner; mornings are walk-in.",
    ...
    reservation: "Contact the venue directly for dinner; daytime is walk-in.",
  ...
  {
    slug: "drifter-surf-cafe",
    displayName: "Drifter Surf Shop & Cafe",
    category: "cafe",
    microArea: "Padang-Padang, Pecatu",
    publication: "published",
    verdict:
      "An all-day surf-shop café on Jl. Labuan Sait — healthy plates, specialty coffee and a slow, browse-the-boards morning between sessions.",
    whyHere:
      "Drifter has been the Bukit's surf-culture living room since 2008: an open-air Javanese limasan wrapped around a lifestyle store, where the coffee is proper and the kitchen leans clean and local. It is the post-surf café for a long, unhurried Uluwatu morning.",
    whatToExpect:
      "A plant-fringed room off the Padang-Padang lane with specialty coffee, smoothie bowls and all-day breakfast, plus surf gear to browse. Mornings are calm; it fills through brunch.",
    bestFor: "post-surf refuel; a healthy breakfast; specialty coffee and a long, slow morning",
    notFor: "a traditional warung experience or a quiet fine-dining dinner",
    atmosphere: "Relaxed open-air surf-shop café",
    visitContext: "On Jl. Labuan Sait near the Padang-Padang break; an easy scooter stop between surfs.",
    reservation: "Walk-in.",
    whatToOrder: ["smoothie bowls", "brekkie burrito", "toasts", "Mandailing coffee"],
    priceBand: "$$",
    address: "Jl. Labuan Sait No.52, Pecatu",
    openingHours: null,
    officialUrl: "https://driftersurf.com/pages/cafe",
    instagramUrl: "https://www.instagram.com/driftersurfshop/",
    bookingUrl: null,
    gmapsUrl: maps("Drifter Surf Shop Cafe Uluwatu Bali"),
    attributes: ["surf-shop café", "all-day breakfast", "specialty coffee"],
    lastVerifiedAt: "2026-07-19",
    evidence: [
      ev("operating_status", "web_search_verification", "https://driftersurf.com/pages/cafe", "VERIFIED", "Official cafe page live; multiple 2026 listings active.", "2026-07-19"),
      ev("micro_area", "web_search_verification", "https://www.tripadvisor.com/Restaurant_Review-g1380108-d12689863-Reviews-Drifter_Surf_Shop_Cafe_Uluwatu-Pecatu_Bukit_Peninsula_Bali.html", "VERIFIED", "Jl. Labuan Sait, Pecatu — inside SW Bukit boundary.", "2026-07-19"),
      ev("official_url", "official_website", "https://driftersurf.com/pages/cafe", "VERIFIED", undefined, "2026-07-19"),
      ev("instagram_url", "official_instagram", "https://www.instagram.com/driftersurfshop/", "VERIFIED", undefined, "2026-07-19"),
      ev("address", "third_party_guide", "https://www.tripadvisor.com/Restaurant_Review-g1380108-d12689863-Reviews-Drifter_Surf_Shop_Cafe_Uluwatu-Pecatu_Bukit_Peninsula_Bali.html", "STALE — RECHECK REQUIRED", "Street number from directory listings; confirm on field visit.", "2026-07-19"),
      researchEv("what_to_order"),
      researchEv("price_band"),
    ],
  },
  {
    slug: "the-cashew-tree",
    displayName: "The Cashew Tree",
    category: "cafe",
    microArea: "Bingin, Pecatu",
    publication: "published",
    verdict:
      "A leafy, vegetarian-leaning garden café above Bingin — wholesome all-day plates by day, and the Bukit's easygoing Thursday live-music night.",
    whyHere:
      "The Cashew Tree is the Bingin community table: an open-air garden serving organic, mostly plant-based food, doubling as a fitness/yoga hub and hosting a long-running Thursday live-music party. It is where the surf-and-wellness crowd lands between the beach and the cliff.",
    whatToExpect:
      "A shaded garden off the Bingin lane with wholesome bowls, fritters and juices and a warm, barefoot crowd. Quiet and healthy by day; Thursday nights turn into an acoustic-to-DJ party running late.",
    bestFor: "a post-surf healthy brunch near Bingin; a laid-back plant-forward meal; the Thursday live-music night",
    notFor: "a formal, fine-dining or meat-forward dinner",
    atmosphere: "Relaxed open-air garden; lively on Thursday nights",
    visitContext: "On the Jl. Pantai Bingin lane above the beach; the lane survived the 2025 Bingin cliff-front demolitions and it is still trading.",
    reservation: "Walk-in; busy on Thursday nights.",
    whatToOrder: ["the soul bowl", "corn fritters", "quesadillas", "fresh juices & smoothies", "vegan cakes"],
    priceBand: "$$",
    address: "Jl. Pantai Bingin, Pecatu",
    openingHours: null,
    officialUrl: null,
    instagramUrl: "https://www.instagram.com/thecashewtree.collective/",
    bookingUrl: null,
    gmapsUrl: maps("The Cashew Tree Bingin Pecatu Bali"),
    attributes: ["vegetarian-leaning", "garden seating", "Thursday live music"],
    lastVerifiedAt: "2026-07-19",
    evidence: [
      ev("operating_status", "web_search_verification", "https://www.instagram.com/thecashewtree.collective/", "VERIFIED", "Active IG + 2025/2026 listings (Bali Guideline, Baligasm, Wanderlog); Bingin-lane location confirmed still trading post-2025 cliff demolitions.", "2026-07-19"),
      ev("micro_area", "web_search_verification", "https://www.tripadvisor.com/Restaurant_Review-g1380108-d7915018-Reviews-The_Cashew_Tree-Pecatu_Bukit_Peninsula_Bali.html", "VERIFIED", "Jl. Pantai Bingin, Pecatu — inside SW Bukit boundary.", "2026-07-19"),
      ev("instagram_url", "official_instagram", "https://www.instagram.com/thecashewtree.collective/", "VERIFIED", undefined, "2026-07-19"),
      ev("address", "google_maps_listing", "https://www.google.com/maps/place/The+Cashew+Tree", "VERIFIED", "Google Maps place listing on Jl. Pantai Bingin.", "2026-07-19"),
      ev("opening_hours", "third_party_guide", null, "CONFLICTING SOURCES", "Third-party sources list Thursday 08:00–00:00 and general daytime hours; not confirmed at source — off-page.", "2026-07-19"),
      researchEv("what_to_order"),
      researchEv("price_band"),
    ],
  },
